pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/Rydizzle1994/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('pylerd-225')   // <---- Change this to match your kubernetes cluster credentials
    }
